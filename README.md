...
- **Plantas:** se reproducen en celdas vecinas vacías cada ciclo. Mueren al superar la edad máxima (20 ciclos).
...
```
├── main.cpp
├── Ecosistema.h / Ecosistema.cpp
├── EntidadViva.h / EntidadViva.cpp
├── Planta.h / Planta.cpp
